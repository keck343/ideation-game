...
class ChapterFive(LevelofStory):
    ...
    def events(self):
            ...
            if yes:
                ...
                if yes:
                    ...
                    if yes_assessment:
                        ...
                        print("""What do you think your camp believes? Type your response below.""")
                        response = input()
                    ...
                    if yes_other_camps:
                        print("""Do you ask the other volunteers about their camps beliefs? (Y/N)""")
                        yes_statements = self.player_yn_to_bool()
                        if yes_statements:
                            ...
                            if choice == 'a':
                                ...
                                print(f"""They respond, while there's some controversy essentially your conference 
                                believes {chapter_sector.core_belief}
                                But our conference believes {alt_sector.core_belief}.""")
        ...
        if attendance != "skip":
            ...
            if not change_sectors:
                ...
                if find_yes:
                    ...
                    They ask you if made it in time to volunteer.""")
                    if attendance == "volunteer":
                        print("""You say you made it and helped with the chairs, 
                        but not to worry because there were plenty of other volunteers.""")
                    else:
                        print("""You shrug and admit you went back to sleep, 
                        but the conference seemed to get along fine.""")
            else:
        ...
        if attendance == "skip":
            ...
            yes = self.player_yn_to_bool()
            if yes:
                print(f"""The headlines read {chapter_camp.second_crisis_explanation}""")
                print(coffee)
                print("""You see your friend depart for the conference. 
            ...
            if not change_sectors:
                ...
                if len(conference_camps) > 0:
                    ...
                    next_camp = chapter_sector.camps[count]
                    ...
                    print(moving_truck)
                    next_camp = random.choice(chapter_sector.camps[1:], 0)
                    return self.main_character, chapter_sector, next_camp, saw_news
